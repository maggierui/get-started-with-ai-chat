...
On the **Drive migrations** tab, review the destination paths of the tasks that you moved to the migrations list, making sure they're correct. A task can't be migrated without a destination indicated. Once you start migrating content to a destination, the destination can't be modified.
