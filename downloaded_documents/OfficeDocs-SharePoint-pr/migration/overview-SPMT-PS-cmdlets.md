...
- **[Register-SPMTMigration](/powershell/module/microsoft.sharepoint.migrationtool.powershell/register-spmtmigration?view=spmt-ps&preserve-view=true)**
...
- **[Add-SPMTTask](/powershell/module/microsoft.sharepoint.migrationtool.powershell/add-spmttask?view=spmt-ps&preserve-view=true)**

Use this cmdlet to add a new migration task to the registered migration session. Currently there are three different types of tasks allowed: File share task, SharePoint task, and JSON defined task. 

**Note**: Duplicate tasks aren't allowed.

### Remove a task

- **[Remove-SPMTTask](/powershell/module/microsoft.sharepoint.migrationtool.powershell/remove-spmttask?view=spmt-ps&preserve-view=true)**

Use this cmdlet to remove an existing migration task from the registered migration.

### Start your migration

- **[Start-SPMTMigration](/powershell/module/microsoft.sharepoint.migrationtool.powershell/start-spmtmigration?view=spmt-ps&preserve-view=true)**

This cmdlet starts the registered SPMT migration.

### Return the object of current session

- **[Get-SPMTMigration](/powershell/module/microsoft.sharepoint.migrationtool.powershell/get-spmtmigration?view=spmt-ps&preserve-view=true)**
...
- **[Stop-SPMTMigration](/powershell/module/microsoft.sharepoint.migrationtool.powershell/stop-spmtmigration?view=spmt-ps&preserve-view=true)**
...
- **[Unregister-SPMTMigration](/powershell/module/microsoft.sharepoint.migrationtool.powershell/unregister-spmtmigration?view=spmt-ps&preserve-view=true)**
...
**Example 2:** The IT admin wants to bring the migration from the background "NoShow mode" to the foreground, and run the following cmdlet so that the migration progress is shown in the console.
