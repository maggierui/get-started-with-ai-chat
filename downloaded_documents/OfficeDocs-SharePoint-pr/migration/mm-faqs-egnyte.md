...
Answer: All accessible files and folders within an Egnyte user (Private folder or Shared folder) are copied. Any items the user doesn't have permission to access are excluded from the migration.
