...
Multiple factors impact the throughput for file share migration. 
...
Answer: Throttling is in place to protect the reliability and availability of the service. Throttling rules can't be disabled or suspended and **opening a support ticket doesn't lift throttle**. For more information, see [Avoid getting throttled or blocked in SharePoint](/sharepoint/dev/general-development/how-to-avoid-getting-throttled-or-blocked-in-sharepoint-online).
