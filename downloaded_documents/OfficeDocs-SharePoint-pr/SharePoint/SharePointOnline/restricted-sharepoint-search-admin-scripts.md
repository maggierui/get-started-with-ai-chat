...
customer-intent: As a SharePoint Administrator or higher in Microsoft 365, I want to use PowerShell scripts to manage Restricted SharePoint Search settings and the allowed list.
ms.topic: how-to
...
## How to enable and manage Restricted SharePoint Search using PowerShell scripts

By default, **Restricted SharePoint Search** isn't enabled. To enable and set up Restricted SharePoint Search, you need to have at least the permissions of a [SharePoint Administrator](/sharepoint/sharepoint-admin-role) in Microsoft 365. Depending on the scenario, some actions you need to take are:

- [Get the current mode](#get-the-current-mode-of-restricted-search) of Restricted Search

- [Enable and disable](#enable-or-disable-restricted-search) Restricted Search

- [Add sites to the allowed list](#add-sites-to-the-allowed-list) by providing URL

- [Remove sites from the allowed list](#remove-sites-from-the-allowlist) by providing URL

- [Get the existing list of URLs that are added in allowlist](#get-the-existing-list-of-urls-in-the-allowed-list) 
...
**Module**: [Microsoft.Online.SharePoint.PowerShell](/powershell/sharepoint/sharepoint-online/introduction-sharepoint-online-management-shell)
