...
Users can use consumption-based services for specific Microsoft 365 features by opting for pay-as-you-go billing through an Azure subscription. Here are the [pricing details](microsoft-365-pay-as-you-go-pricing.md) for the service(s).
