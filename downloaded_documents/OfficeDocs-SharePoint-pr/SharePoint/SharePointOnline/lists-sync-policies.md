...
> [!NOTE]
> To preserve Lists performance acceleration when the Chromium-based browser restrictions on local network access take effect, deploy the browser policy `LocalNetworkAccessAllowedForUrls` now.  
> Add your tenant’s SharePoint Online and OneDrive endpoints (for example:
> - `https://YOURTENANT-my.sharepoint.com`  
> - `https://YOURTENANT.sharepoint.com`  
>Policy reference (Edge): [https://learn.microsoft.com/deployedge/microsoft-edge-browser-policies/localnetworkaccessallowedforurls](/deployedge/microsoft-edge-browser-policies/localnetworkaccessallowedforurls)  
>Policy reference (Chrome):  https://chromeenterprise.google/policies/#LocalNetworkAccessAllowedForUrls  
