...
|**Project Server Workflow 2013** <br/> |Windows Workflow Foundation 4  <br/> |Requires Project server.  <br/> |
|**Project Server Workflow 2016 or higher** <br/> |Windows Workflow Foundation 4  <br/> |Installs automatically with SharePoint Server.  <br/> |
...
> 2. Project Server 2016 or higher has been integrated into SharePoint Server; Project Server needs to be activated first when it's installed automatically upon the installation of SharePoint Server.
...
> 6. Verify the Microsoft Azure Service Fabric version from the Control Panel.
> 7. Rejoin the server using Workflow Configuration Manager.
>
...
> [!IMPORTANT]
> Because the upgrade steps require that you disjoin and then rejoin an existing WFM farm, you will need the WFM "Certificate Generation Key", when rejoining. If you aren't sure what that key is, and haven't documented it somewhere, you may need to [Reset Certificate Generation Key](/SharePoint/governance/reset-certificate-generation-key-sharepoint-workflow-manager) before proceeding. 
