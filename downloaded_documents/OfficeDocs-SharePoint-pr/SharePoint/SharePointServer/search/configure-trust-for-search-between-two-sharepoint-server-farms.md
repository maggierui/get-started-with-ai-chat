...
2. On a server in ReceivingFarm, start the SharePoint Management Shell.
   ...
   - For Windows Server 2012:
    ...
    For more info about how to interact with Windows Server 2012, see [Common Management Tasks and Navigation in Windows Server 2012](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/hh831490(v=ws.11)).
