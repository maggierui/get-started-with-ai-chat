...
1. Verify that you meet the following minimum requirements:
   ...
   For more information about PowerShell permissions, see [Permissions](/archive/technet-wiki/34284.sharepoint-2016-list-of-powershell-cmdlets#section3&preserve-view=true) and [Add-SPShellAdmin](/powershell/module/sharepoint-server/Add-SPShellAdmin?view=sharepoint-ps&preserve-view=true)
...
4. To retrieve the service application, type the following command:
   ...
   > [!IMPORTANT]
   > The display name must be enclosed in quotation marks, and it must exactly match the service application display name. This includes capitalization. If you have more than one service application that has the identical display name (we don't recommend this), you can use the **Get-SPServiceApplication** cmdlet to view all service applications. You can then identify the service application by its GUID. For more information, see [Get-SPServiceApplication](/powershell/module/sharepoint-server/Get-SPServiceApplication?view=sharepoint-ps&preserve-view=true). 
