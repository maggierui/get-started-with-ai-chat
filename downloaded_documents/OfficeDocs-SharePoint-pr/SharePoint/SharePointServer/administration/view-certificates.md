...
SharePoint supports finding certificates via the [Get-SPCertificate](/powershell/module/sharepointserver/get-spcertificate) PowerShell cmdlet. Optional parameters are available to filter the results returned by this cmdlet.
