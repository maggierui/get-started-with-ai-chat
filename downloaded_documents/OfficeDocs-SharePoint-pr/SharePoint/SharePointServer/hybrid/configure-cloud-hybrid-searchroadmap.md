...
|**2. [Create a cloud Search service application in SharePoint Server](configure-cloud-hybrid-searchroadmap.md#BKMK_CreateCloudSSA)** <br/> |<br/>Use the SharePoint Central Administration website to create a cloud SSA. Alternatively, run the **CreateCloudSSA.ps1** PowerShell script to create a cloud SSA.<br/> |
|**3. [Connect your cloud Search service application to your Microsoft 365 organization](configure-cloud-hybrid-searchroadmap.md#BKMK_ConnectCloudSSAToO365)** <br/> |Run the **Onboard-CloudHybridSearch-SPOONS.ps1** PowerShell script to onboard your cloud SSA and Microsoft 365 organization to cloud hybrid search. The script sets up the cloud SSA to interact with the Microsoft 365 organization.  <br/> |
...
1. Make sure you're using the same user account as when you installed SharePoint Server. This account is granted the appropriate permissions to run Windows PowerShell cmdlets.
...
1. Download and install version 2.25.0  of the [Microsoft Graph PowerShell module](/powershell/microsoftgraph/installation) from the PowerShell Gallery. This step isn't required if you're using Onboard-CloudHybridSearch-SPOONS.ps1.
   
   ```powershell
   Install-Module Microsoft.Graph -RequiredVersion 2.25.0 
   ```
    
1. Download the [Onboard-CloudHybridSearch-SPOONS.ps1](https://www.microsoft.com/en-us/download/details.aspx?id=51490) PowerShell script from the Microsoft Download Center.

1. Run the  **Onboard-CloudHybridSearch-SPOONS.ps1** PowerShell script as follows: 
...
1. Onboarding is now supported for Office 365 US Government Communication environments. .
...
1. A new window appears asking you to sign in again. Input the same account you used in step1. 
...
1. Verify that the user account that's performing this procedure is an administrator for the cloud SSA.
...
1. Verify that the user account that's performing this procedure is an administrator for the Cloud Search service application.
