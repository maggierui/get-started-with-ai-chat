...
|**Databaserepair**  |Use [Get-SPContentDatabaseOrphanedData](/powershell/module/sharepoint-server/Get-SPContentDatabaseOrphanedData?view=sharepoint-ps&preserve-view=true) to detect orphaned data, but note that it doesn't repair orphaned data.  |
...
[Index of Microsoft PowerShell cmdlets for SharePoint Server](/archive/technet-wiki/34284.sharepoint-2016-list-of-powershell-cmdlets)
