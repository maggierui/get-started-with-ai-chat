...
Make sure you have [permissions to administer SharePoint Server with Windows PowerShell](/archive/technet-wiki/34284.sharepoint-2016-list-of-powershell-cmdlets), and log in to a server in your SharePoint farm. Open the SharePoint 2016 Management Shell as administrator and run the following script:
