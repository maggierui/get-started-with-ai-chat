...
To enable this feature and specify the site for organization news, a SharePoint Administrator must use the [SharePoint Online PowerShell commands](/powershell/module/microsoft.online.sharepoint.powershell):
