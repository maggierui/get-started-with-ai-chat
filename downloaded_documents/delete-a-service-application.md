...
1. Verify that you meet the following minimum requirements:
   ...
   For additional information about PowerShell permissions, see [Permissions](/archive/technet-wiki/34284.sharepoint-2016-list-of-powershell-cmdlets#section3) and [Add-SPShellAdmin](/powershell/module/sharepoint-server/Add-SPShellAdmin?view=sharepoint-ps&preserve-view=true)
