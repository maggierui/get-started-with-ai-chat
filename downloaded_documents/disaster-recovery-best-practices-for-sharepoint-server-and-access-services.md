...
> [!IMPORTANT]
> Before you can use any of the Microsoft PowerShell cmdlets detailed in the steps below, verify that you meet all of the requirements in [Permissions](/archive/technet-wiki/34284.sharepoint-2016-list-of-powershell-cmdlets#section3). 
...
Before you can use any of the Microsoft PowerShell cmdlets, verify that you meet all of the requirements in [Permissions](/archive/technet-wiki/34284.sharepoint-2016-list-of-powershell-cmdlets#section3).
