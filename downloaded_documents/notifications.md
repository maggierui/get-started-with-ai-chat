...
You can also control this setting in PowerShell by using [Set-SPOTenant -NotificationsInSharePointEnabled](/powershell/module/microsoft.online.sharepoint.powershell/set-spotenant).
