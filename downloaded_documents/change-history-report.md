...
manager: dansimp
audience: Admin
customer-intent: As a SharePoint administrator, I want to create and view change history reports to monitor site actions and organization setting changes.
f1.keywords:
- NOCSH
ms.topic: how-to
...
# Track site actions or organization setting changes made within the last 180 days with change history reports
...
:::image type="content" source="media/change-history/2-change-history-dashboard-panel-expanded.png" alt-text="Screenshot of change history dashboard with a prefilled new report panel." lightbox="media/change-history/2-change-history-dashboard-panel-expanded.png":::
