...
![A diagram of a hub site with associated sites.](media/rss-hubsite-example.png) 
...
You can enable Restricted SharePoint Search by using PowerShell scripts. For detailed steps, see [Enable or disable Restricted Search](/sharepoint/restricted-sharepoint-search-admin-scripts#enable-or-disable-restricted-search).

### After [enabling RSS](restricted-sharepoint-search-admin-scripts.md#enable-or-disable-restricted-search) how long does it take to take place?
